...
public class studentLoginPanel extends JPanel {
    ...
    public studentLoginPanel(mainFrame frame) {
        ...
        studentCard.setPreferredSize(new Dimension(450, 480));
        studentCard.setOpaque(false);
        studentCard.setLayout(new GridBagLayout());
        studentCard.setBorder(new EmptyBorder(50, 50, 50, 50));
        ...
        // TITLE
        // =========================
        JLabel header = new JLabel("Student Access", SwingConstants.CENTER);
        header.setFont(new Font("Segoe UI", Font.BOLD, 26));
        header.setForeground(ACCENT);

        gbc.gridy = 0;
        gbc.insets = new Insets(0, 0, 10, 0);
        studentCard.add(header, gbc);

        JLabel subtitle = new JLabel("View Your Academic Timetable", SwingConstants.CENTER);
        subtitle.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        subtitle.setForeground(TEXT_SECONDARY);

        gbc.gridy = 1;
        gbc.insets = new Insets(0, 0, 40, 0);
        studentCard.add(subtitle, gbc);

        // =========================
        // ROLL NUMBER
        // =========================
        JLabel regLabel = new JLabel("ROLL NUMBER");
        regLabel.setFont(new Font("Segoe UI", Font.BOLD, 14));
        regLabel.setForeground(TEXT_PRIMARY);

        gbc.gridy = 2;
        gbc.insets = new Insets(0, 0, 8, 0);
        studentCard.add(regLabel, gbc);

        regField = createModernField();

        gbc.gridy = 3;
        gbc.insets = new Insets(0, 0, 35, 0);
        studentCard.add(regField, gbc);

        // =========================
        // BUTTON
        // =========================
        JButton viewBtn = createModernButton("View Timetable");

        gbc.gridy = 4;
        gbc.insets = new Insets(0, 0, 25, 0);
        studentCard.add(viewBtn, gbc);

        // =========================
        // BACK LINK
        // =========================
        JLabel backLink = new JLabel("← Back to Roles", SwingConstants.CENTER);
